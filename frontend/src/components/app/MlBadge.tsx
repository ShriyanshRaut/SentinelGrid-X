...
const MlBadge = ({
  ...
  if (risk == null && score == null && anomaly == null) {
    return null;
  }
  ...
  return (
    <div className="flex items-center gap-1.5 flex-wrap">
      {risk != null && (
        <span
          className={`inline-flex items-center gap-1 rounded-full px-2 py-0.5 text-[10px] font-mono uppercase tracking-wider border ${riskStyle(
            risk
          )}`}
